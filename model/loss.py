...
class Loss(nn.Module):
    ...
    def forward(self,det,label):
        ...
        cls_loss = self.focal_loss(y1[1],l1[1]) + self.focal_loss(y2[1],l2[1])
        angleandlength_loss = self.mse(y1[2],l1[2]) + self.mse(y2[2],l2[2])
        center_loss = self.mse(y1[3],l1[3]) + self.mse(y2[3],l2[3])
